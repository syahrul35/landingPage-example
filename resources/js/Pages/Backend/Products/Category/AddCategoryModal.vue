    ...
    <transition name="modal">
        <div class="fixed z-50 inset-0 overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true">
            <div class="flex items-center justify-center min-h-screen px-4 py-6 text-center sm:block sm:p-0">
                <div class="fixed inset-0 bg-gray-500 bg-opacity-75 transition-opacity" @click="closeAddCategoryModal"></div>
                ...
                <div
                    ...
                    <div class="bg-gray-900 px-4 py-3 sm:px-6 sm:flex sm:flex-row justify-end">
                        ...
                        <button @click="closeAddCategoryModal" type="button"
...
// Modal
const emits = defineEmits(['closeAddCategoryModal']);

const closeAddCategoryModal = () => {
    emits('closeAddCategoryModal');
};
// end Modal
