                        ...
                        <tbody>
                            <tr v-for="(gallery, index) in sliders" :key="index" class="hover:bg-gray-50">
                                ...
                                <td class="py-3 px-4 border-b text-center">
                                    <input 
                                        type="checkbox" 
                                        v-model="gallery.active" 
                                        @change="toggleActive(gallery)" 
                                ...
                                <td class="py-1 px-2 border-b text-center">
                                    <div class="flex justify-center space-x-2">
                                        ...
                                        <button 
                                            @click="openEditGalleryModal(gallery)" 
...
function closeEditGalleryModal(gallery) {
    showEditModal.value = false
}

function detailGallery(gallery) {
    // Logic for detail the gallery
}
