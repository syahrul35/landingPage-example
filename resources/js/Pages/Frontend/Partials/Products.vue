<template>
    <section id="products" class="container mx-auto p-4">
        ...
        <div class="grid grid-cols-3 gap-4">
            <div v-for="product in products" :key="product.id" class="border p-2 bg-white shadow-lg rounded-lg transition duration-500 ease-in-out transform hover:-translate-y-1 hover:shadow-2xl">
                ...
                <div class="py-2">
                    ...
                    <div class="flex items-center mt-1">
                        <svg v-for="n in 5" :key="n" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
